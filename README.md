...
- **Translate** (⌃⌥T) — opens **whatever is on your clipboard** in Google Translate in your
...
|---|---|---|
| Trigger | ⌃⌥D (Polish), ⌃⌥⇧D (Proofread), ⌃⌥T (Translate — clipboard) | select → right-click → Services → **Polish with McGrammar**, **Proofread with McGrammar** or **Translate with McGrammar** |
...
Translate takes a different input on each path, on purpose. **⌃⌥T translates your clipboard**: copy
...
have to press a chord for. **⌃⌥T sends your clipboard — and the Translate Services item your
